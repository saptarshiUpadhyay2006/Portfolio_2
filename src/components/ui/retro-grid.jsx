...
const ANIMATION_DURATION_SECONDS = 30
...
export function RetroGrid({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "pointer-events-none absolute inset-0 overflow-hidden [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_75%,transparent_100%)]",
        className
      )}
      style={gridStyles}
      {...props}
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#05070a] via-transparent to-[#05070a] opacity-75 pointer-events-none" />
    </div>
  )
}
